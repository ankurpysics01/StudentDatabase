...
class Student
{
    ...
    void addStudent()
    {
        ...
        ofstream fout;
        fout.open("c:/Ankur/student.txt", ios::app);
        fout<<"\n"<<ID;
        fout<<"\n"<<name;
        fout<<"\n"<<age;
        fout<<"\n"<<stream;
        ...
        fout.open("c:/Ankur/ID.txt",ios::app);
        fout<<"\n"<<ID;
        fout.close();
    ...
    void deleteStudent(int id)
    {
        ...
        remove("c:/Ankur/student.txt");
        rename("c:/Ankur/temp.txt" , "c:/Ankur/student.txt");
